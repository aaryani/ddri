...
public class Harvester {
	...
	public void harvestPublications() {
		QueryResult<Map<String, Object>> nodes = engine.query("MATCH (n:Dryad:Publication) RETURN ID(n) AS id, n.title AS title", null);
						...
						try {
							...
							if (null != page) {
								if (publications.containsKey(publicationTitle)) {
									...
									publication = new Publication(nodeId, publicationTitle, link);
